...
// module.exports = MagicGrid;  <- 다른 프레임워크에서 사용
...
//이미지로딩이 늦어져서 레이아웃이 렌딩이 지연되는 것을 방지

var marsonrys = document.getElementsByTagName("img");


//html 내 img들에 대하여 img가 load되었을 때, magicGrid를 다시 배치하기(posionItems)
for (let i = 0; i< marsonrys.length; i++){
  marsonrys[i].addEventListener("load", function(){       //load가 되었을 때 fucntion실행
    magicGrid.positionItems();                            //->그 function
      }, false
  );
}
